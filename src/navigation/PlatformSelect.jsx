...
export default function PlatformSelect({ user, onSelect, onLogout, onOpenProfile }) {
  return (
    <div className="platform-page">
      <main className="platform-main">
        ...
        <div className="platform-header-row">
          <button type="button" className="platform-profile-btn" onClick={onOpenProfile} title="Edit profile">
